                    ...
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input type="text" placeholder="e.g., Ahmed Khan" className="w-full h-12 px-4 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all text-sm" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-slate-700 ml-1">WhatsApp number</label>
                                <input type="text" placeholder="+92 300 1234567" className="w-full h-12 px-4 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all text-sm" />
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea placeholder="e.g., Meezan Bank, IBAN PK40MEZN0000..." className="w-full h-24 p-4 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all text-sm resize-none"></textarea>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-slate-700 ml-1">Total amount donated (PKR)</label>
                                <input type="number" placeholder="e.g., 15000" className="w-full h-12 px-4 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all text-sm" />
                            </div>
                            <div className="space-y-2">
                        ...
                        <Button className="w-full h-14 bg-slate-300 text-slate-500 font-bold rounded-xl mt-4 cursor-not-allowed uppercase text-sm tracking-wide">
